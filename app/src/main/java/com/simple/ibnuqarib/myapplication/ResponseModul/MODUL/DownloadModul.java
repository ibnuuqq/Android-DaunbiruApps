...
public class DownloadModul extends AppCompatActivity {
    WebView webView;
    ProgressBar bar;
    @SuppressLint("SetJavaScriptEnabled")
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.download_modul);
        webView = (WebView) findViewById(R.id.view_modulDownload);
        bar=(ProgressBar) findViewById(R.id.progresModul);
        //showDownload();
